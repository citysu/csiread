...
def matlab_read(matfile='log.all_csi.6.7.6.mat'):
	...
	mldata = {}
	pk_num = 29
	mldata['timestamp_low'] = np.zeros([pk_num], dtype=np.intp)
	mldata['bfee_count'] = np.zeros([pk_num], dtype=np.intp)
	mldata['Nrx'] = np.zeros([pk_num], dtype=np.intp)
	mldata['Ntx'] = np.zeros([pk_num], dtype=np.intp)
	mldata['rssi_a'] = np.zeros([pk_num], dtype=np.intp)
	mldata['rssi_b'] = np.zeros([pk_num], dtype=np.intp)
	mldata['rssi_c'] = np.zeros([pk_num], dtype=np.intp)
	mldata['noise'] = np.zeros([pk_num], dtype=np.intp)
	mldata['agc'] = np.zeros([pk_num], dtype=np.intp)
	mldata['perm'] = np.zeros([pk_num, 3], dtype=np.intp)
	mldata['rate'] = np.zeros([pk_num], dtype=np.intp)
	mldata['csi'] = np.zeros([pk_num, 30, 3, 3], dtype=np.complex128)
	mldata['scaled_csi'] = np.zeros([pk_num, 30, 3, 3], dtype=np.complex128)
	mldata['scaled_csi_sm'] = np.zeros([pk_num, 30, 3, 3], dtype=np.complex128)
